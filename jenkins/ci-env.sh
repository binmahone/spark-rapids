...
export SPARK_RAPIDS_VERSION=$(mvn help:evaluate -q -f $SPARK_RAPIDS_POM -N -Dexpression=project.version -DforceStdout)
export DEFAULT_CUDA_CLASSIFIER=$(mvn help:evaluate -q -f $SPARK_RAPIDS_POM -N -Dexpression=cuda.version -DforceStdout)
SPARK_RAPIDS_JNI_URL_SUFFIX="com/nvidia/spark-rapids-jni/$JNI_VERSION/spark-rapids-jni-$JNI_VERSION-$DEFAULT_CUDA_CLASSIFIER.jar"
...
export SPARK_RAPIDS_IT_IMAGE=${SPARK_RAPIDS_IT_IMAGE:-"$ARTIFACTORY_NAME/sw-spark-docker/bd-spark-rapids-runtime:20250418-disable-GDPR"}
...
echo "SPARK_RAPIDS_IT_IMAGE=$SPARK_RAPIDS_IT_IMAGE"
echo "DEFAULT_CUDA_CLASSIFIER=$DEFAULT_CUDA_CLASSIFIER"
echo "SPARK_RAPIDS_VERSION=$SPARK_RAPIDS_VERSION"
