...
object GpuMetric extends Logging {
  ...
  val FILECACHE_P2P_FOOTER_MISSES = "filecacheP2pFooterMisses"
  val FILECACHE_P2P_DATA_RANGE_HITS = "filecacheP2pDataRangeHits"
  ...
  val DESCRIPTION_FILECACHE_P2P_FOOTER_MISSES = "P2P footer misses"
  val DESCRIPTION_FILECACHE_P2P_DATA_RANGE_HITS = "P2P data range hits (cross-executor)"
