...
object GpuMetric extends Logging {
  ...
  val BUFFER_ALLOC_TIME = "bufferAllocTime"
  val BUFFER_COPY_TIME = "bufferCopyTime"
  val BUFFER_HEADER_TIME = "bufferHeaderTime"
  val BUFFER_FOOTER_TIME = "bufferFooterTime"
  val BUFFER_REALLOC_TIME = "bufferReallocTime"
  ...
  val FILTER_PARALLEL_TIME = "filterParallelTime"
  ...
  val DESCRIPTION_BUFFER_ALLOC_TIME = "buffer allocation time"
  val DESCRIPTION_BUFFER_COPY_TIME = "buffer copy time (parallel file read)"
  val DESCRIPTION_BUFFER_HEADER_TIME = "buffer header write time"
  val DESCRIPTION_BUFFER_FOOTER_TIME = "buffer footer write time"
  val DESCRIPTION_BUFFER_REALLOC_TIME = "buffer reallocation time"
  ...
  val DESCRIPTION_FILTER_PARALLEL_TIME = "filter time (parallel execution)"
