...
<a name="sql.udf.autoMapping.enabled"></a>spark.rapids.sql.udf.autoMapping.enabled|When set to true, automatically maps UDFs to GPU implementations according to some rules.|false|Runtime
