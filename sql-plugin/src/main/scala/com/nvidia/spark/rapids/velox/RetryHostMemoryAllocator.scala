...
import com.nvidia.spark.rapids.velox.{HostMemoryAllocator => HybridMemoryAllocator}
 ...
 *
 * This is designed to support retry things for the host allocation in velox scans.
 */
