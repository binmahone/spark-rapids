...
object GpuMetric extends Logging {
  ...
  val FOOTER_READ_FS_TIME = "footerReadFsTime"
  val FILE_GET_LENGTH_TIME = "fileGetLengthTime"
  val PARQUET_PARSE_FILTER_FOOTER_TIME = "parquetParseFilterFooterTime"
  val PARQUET_READ_FILTERED_FOOTER_TIME = "parquetReadFilteredFooterTime"
  val PARQUET_GET_BLOCKS_WITH_FILTER_TIME = "parquetGetBlocksWithFilterTime"
  val PARQUET_CLIP_SCHEMA_TIME = "parquetClipSchemaTime"
  ...
  val DESCRIPTION_FOOTER_READ_FS_TIME = "time to read footer fs data"
  val DESCRIPTION_FILE_GET_LENGTH_TIME = "file get length time"
  val DESCRIPTION_PARQUET_PARSE_FILTER_FOOTER_TIME = "parquet parse filter footer time"
  val DESCRIPTION_PARQUET_READ_FILTERED_FOOTER_TIME = "parquet read filtered footer time"
  val DESCRIPTION_PARQUET_GET_BLOCKS_WITH_FILTER_TIME = "parquet get blocks with filter time"
  val DESCRIPTION_PARQUET_CLIP_SCHEMA_TIME = "parquet clip schema time"
